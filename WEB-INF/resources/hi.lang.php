...
$i18n_language = 'Hindi';
$i18n_months = array('जनवरी', 'फरवरी', 'मार्च', 'अप्रैल', 'मई', 'जून', 'जुलाई', 'अगस्त', 'सितंबर', 'अक्टूबर', 'नवंबर', 'दिसंबर');
$i18n_weekdays = array('रविवार सोमवार मंगलवार बुधवार गुरुवार शुक्रवार शनिवार');
$i18n_weekdays_short = array('रवि', 'सोम', 'मंगल', 'बुध', 'गुरु', 'शुक्ड़ा', 'शनि');
// format mm/dd
...
'menu.forum' => 'मंच',
'menu.help' => 'सहायता',
'menu.create_group' => 'समूह बनाएँ',
'menu.profile' => 'पार्श्वचित्र',
'menu.group' => 'समूह',
'menu.time' => 'समय',
'menu.expenses' => 'खर्चों',
'menu.reports' => 'रिपोर्टों',
'menu.charts' => 'चार्ट',
'menu.projects' => 'परियोजनाएं',
'menu.tasks' => 'कार्य',
'menu.users' => 'उपयोगकर्ताओं',
'menu.export' => 'निर्यात',
'menu.groups' => 'समूहों',
'menu.clients' => 'ग्राहकों',
'menu.options' => 'विकल्पों',

// Footer - strings on the bottom of most pages.
'footer.contribute_msg' => 'आप अलग-अलग तरीकों से टाइम ट्रैकर में योगदान कर सकते हैं।',
'footer.credits' => 'आभार',
'footer.license' => 'अनुज्ञप्ति',
'footer.improve' => 'योगदान', // Translators: this could mean "Improve", if it makes better sense in your language.
                                  // This is a link to a webpage that describes how to contribute to the project.

// Error messages.
'error.access_denied' => 'पहुंच अस्वीकृत',
'error.sys' => 'प्रणाली त्रुटि',
'error.db' => 'डाटाबेस त्रुटि',
'error.feature_disabled' => 'सुविधा अक्षम है।',
'error.field' => 'ग़लत "{0}" data.',
'error.empty' => 'क्षेत्र "{0}" खाली है।',
'error.not_equal' => 'क्षेत्र "{0}" के बराबर नहीं है क्षेत्र "{1}".',
'error.interval' => 'क्षेत्र "{0}" से अधिक होना चाहिए "{1}".',
'error.project' => 'चुनिंदा परियोजना',
'error.task' => 'कार्य का चयन करें',
'error.client' => 'ग्राहक का चयन करें।',
'error.report' => 'रिपोर्ट का चयन करें।',
